    ...
    <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 text-slate-900 font-sans selection:bg-blue-600/30">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-[40px] relative z-10">
          ...
          <h1 className="text-4xl font-extrabold tracking-normal uppercase text-slate-900 leading-none text-center">
        ...
        <form onSubmit={handleSubmit} className="relative z-10 flex flex-col" noValidate>
          <div className="mb-[24px]">
            ...
            <div className="relative flex items-center">
              <User size={22} className="absolute left-[16px] top-1/2 -translate-y-1/2 text-slate-400 pointer-events-none" />
              <input
                type="text"
                required
                ...
                onChange={(e) => {
                  ...
                  if (displayError) { clearError(); setLocalError(''); }
                }}
              />
            </div>
          </div>
        ...
        <div className="mt-[32px] flex flex-row items-center justify-center gap-2 relative z-10">
          <p className="font-bold text-slate-500 text-xs uppercase tracking-widest">
            Already have account?
          </p>
          <button 
            className="text-slate-900 font-bold hover:text-blue-600 uppercase tracking-widest text-xs transition-colors"
