...
const Landing = () => {
  ...
  return (
    <div className="min-h-screen bg-sky-wash font-sans text-carbon-black relative overflow-x-hidden">
      ...
      {/* NAVBAR CONTAINER */}
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 sticky z-50 transition-all duration-300 ${isScrolled ? 'top-2 pt-2' : 'top-4 pt-6'}`}>
        <nav className={`bg-white border border-carbon-black rounded-full px-6 transition-all duration-300 flex items-center justify-between relative ${isScrolled ? 'py-2.5 shadow-brutal-sm' : 'py-3.5 shadow-brutal'}`}>
          <div 
            onClick={() => navigate('/')}
            className="flex items-center gap-3 transition-transform hover:scale-102 duration-200 cursor-pointer group"
          >
                ...
                >
                  {isActive && (
                    <motion.span
                      ...
                      className="absolute inset-0 bg-lime-pulse border border-carbon-black shadow-brutal-sm rounded-full -z-10"
          ...
          <div className="hidden md:flex items-center gap-3">
            <motion.button
              whileHover={{ scale: 1.03, y: -1, boxShadow: "3px 3px 0px 0px #0a0a0d" }}
              whileTap={{ scale: 0.97 }}
              onClick={() => navigate('/login')}
              className="bg-white hover:bg-white text-carbon-black font-bold text-sm px-5 py-2 rounded-full border border-carbon-black shadow-brutal transition-all duration-200"
            >
              Login
            </motion.button>
            <motion.button
              ...
              className="bg-lime-pulse hover:bg-[#97d82f] text-carbon-black font-bold text-sm px-5 py-2 rounded-full border border-carbon-black shadow-brutal transition-all duration-200"
            >
              Signup
            </motion.button>
          </div>
          ...
          <AnimatePresence>
            {isMenuOpen && (
              <motion.div
                ...
                className="absolute top-full left-0 right-0 mt-3 bg-white border border-carbon-black rounded-3xl p-6 shadow-brutal-dark flex flex-col gap-4 overflow-hidden"
              >
                {['solutions', 'features', 'insights', 'company'].map((sec) => (
                  <a
                    key={sec}
                    href={`#${sec}`}
                    onClick={(e) => scrollToSection(e, sec)}
                    className="font-bold text-lg text-iron hover:bg-lime-pulse/10 p-2 rounded-xl transition-all"
                  >
                ...
                <div className="flex gap-3 mt-2 border-t border-black/10 pt-4">
                  <button
                    onClick={() => navigate('/login')}
                    className="flex-1 bg-white hover:bg-white text-carbon-black font-bold text-sm py-3 rounded-full border border-carbon-black shadow-brutal"
                  >
                    Login
                  </button>
                  <button
                    onClick={() => navigate('/signup')}
                    className="flex-1 bg-lime-pulse hover:bg-[#97d82f] text-carbon-black font-bold text-sm py-3 rounded-full border border-carbon-black shadow-brutal"
                  >
                    Signup
                  </button>
                </div>
      ...
      <main className="w-full">
        ...
        <section className="bg-sky-wash pt-16 pb-20 md:pt-24 md:pb-28 relative w-full overflow-hidden">
          ...
          <motion.div
            ...
            className="absolute top-[20%] left-[8%] hidden lg:flex items-center justify-center w-14 h-14 bg-white border border-carbon-black rounded-full shadow-brutal z-20"
          >
          ...
          <motion.div
            ...
            className="absolute top-[30%] right-[10%] hidden lg:flex items-center justify-center w-12 h-12 bg-white border border-carbon-black rounded-full shadow-brutal z-20"
          >
          ...
          <motion.div
            ...
            className="absolute bottom-[25%] left-[12%] hidden lg:flex items-center justify-center w-12 h-12 bg-white border border-carbon-black rounded-full shadow-brutal z-20"
          >
          ...
          <motion.div
            ...
            className="absolute top-[15%] right-[25%] hidden lg:flex items-center justify-center w-10 h-10 bg-white border border-carbon-black rounded-full shadow-brutal z-20"
          >
          ...
          >
            ...
            >
              <motion.button
                whileHover={{ scale: 1.03, y: -2, boxShadow: "4px 4px 0px 0px #0a0a0d" }}
                whileTap={{ scale: 0.97 }}
                onClick={() => navigate('/signup')}
                className="bg-lime-pulse hover:bg-[#97d82f] text-carbon-black px-8 py-4 rounded-full font-bold text-lg flex items-center gap-3 border border-carbon-black shadow-brutal transition-all duration-200 relative group"
              >
                <motion.div
                ...
                <motion.div
                  ...
                  className="absolute -top-5 -right-5 bg-amber-spark w-11 h-11 rounded-full border border-carbon-black flex items-center justify-center text-[10px] font-bold uppercase text-center leading-tight shadow-sm"
                >
              ...
              <motion.button
                ...
                className="bg-white hover:bg-white text-carbon-black px-8 py-4 rounded-full font-bold text-lg border border-carbon-black shadow-brutal transition-all duration-200"
              >
                Open App
              </motion.button>
            </motion.div>
        ...
        <section id="solutions" className="bg-white py-16 scroll-mt-24">
          <div className="max-w-7xl mx-auto px-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
              ...
              <FadeIn delay={0.1}>
                <motion.div 
                  whileHover={{ y: -6, boxShadow: "5px 5px 0px 0px #0a0a0d", borderColor: "#3366e0" }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  className="bg-buttercream rounded-xl p-8 md:p-10 border border-carbon-black shadow-brutal flex flex-col h-full text-carbon-black cursor-pointer"
                >
                  <div className="mb-auto">
                    <div className="bg-white w-12 h-12 rounded-full border border-carbon-black flex items-center justify-center mb-6">
              ...
              <FadeIn delay={0.2}>
                <motion.div 
                  whileHover={{ y: -6, boxShadow: "5px 5px 0px 0px #0a0a0d", borderColor: "#3366e0" }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  className="bg-mint-wash rounded-xl p-8 md:p-10 border border-carbon-black shadow-brutal flex flex-col h-full text-carbon-black cursor-pointer"
                >
                  <div className="mb-auto">
                    <div className="bg-white w-12 h-12 rounded-full border border-carbon-black flex items-center justify-center mb-6">
              ...
              <FadeIn delay={0.3}>
                <motion.div 
                  whileHover={{ y: -6, boxShadow: "5px 5px 0px 0px #0a0a0d", borderColor: "#3366e0" }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  className="bg-bubblegum rounded-xl p-8 md:p-10 border border-carbon-black shadow-brutal flex flex-col h-full text-carbon-black cursor-pointer"
                >
                  <div className="mb-auto">
                    <div className="bg-white w-12 h-12 rounded-full border border-carbon-black flex items-center justify-center mb-6">
                      <ShieldAlert className="w-6 h-6 text-carbon-black stroke-[2]" />
        ...
        <WaveDivider fill="#ffffff" bg="#d2fae5" />

        {/* FEATURES SECTION */}
        <section id="features" className="bg-mint-wash py-20 scroll-mt-24 border-t border-b border-carbon-black/5 relative">
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {[
                ...
                { step: 4, title: 'Action', desc: 'Get directed to a doctor or remedy.', icon: ArrowRight, color: 'bg-[#a3e635]' }
              ].map((item, i) => (
                <FadeIn key={item.step} delay={i * 0.1}>
                  <motion.div 
                    whileHover={{ y: -6, boxShadow: "6px 6px 0px 0px #171717", borderColor: "#3366e0" }}
                    transition={{ type: "spring", stiffness: 300, damping: 20 }}
                    className="bg-white border border-carbon-black rounded-2xl p-8 h-full shadow-brutal-dark relative flex flex-col text-carbon-black cursor-pointer"
                  >
                    <div className={`absolute -top-4 -right-4 w-10 h-10 rounded-full ${item.color} border border-carbon-black flex items-center justify-center font-bold text-lg z-20 shadow-brutal text-carbon-black`}>
                      {item.step}
                    </div>
                    <div className="bg-[#f5f5f5] w-12 h-12 rounded-full border border-carbon-black/20 flex items-center justify-center mb-6">
        ...
        <WaveDivider fill="#d2fae5" bg="#ffffff" />
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <FadeIn delay={0.1} className="h-full">
                <motion.section 
                  whileHover={{ y: -6, boxShadow: "6px 6px 0px 0px #171717", borderColor: "#3366e0" }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  className="bg-white border border-carbon-black rounded-2xl p-8 md:p-12 relative flex flex-col justify-between h-[500px] shadow-brutal-dark text-carbon-black cursor-pointer transition-colors duration-300"
                >
                  <h3 className="text-3xl font-bold mb-8 uppercase italic">Live Example</h3>
                  
                  <div className="w-full flex-grow flex flex-col justify-center">
                    <div className="bg-white border border-carbon-black rounded-xl p-4 w-5/6 mb-6 shadow-brutal relative z-10 text-carbon-black font-medium">
                    ...
                    <AnimatePresence>
                      <motion.div
                        ...
                        className="bg-[#f87171] border border-carbon-black rounded-2xl p-6 text-carbon-black ml-auto relative z-10 shadow-brutal-dark w-5/6"
                      >
              ...
              <FadeIn delay={0.2} className="h-full">
                <motion.section 
                  whileHover={{ y: -6, boxShadow: "6px 6px 0px 0px #171717", borderColor: "#3366e0" }}
                  transition={{ type: "spring", stiffness: 300, damping: 20 }}
                  className="bg-mint-wash border border-carbon-black rounded-2xl p-8 md:p-12 flex flex-col justify-between h-[500px] shadow-brutal-dark text-carbon-black cursor-pointer transition-colors duration-300"
                >
                  <h3 className="text-3xl font-bold mb-6 uppercase italic">Instant Triage Report</h3>
                  
                  <div className="bg-white border border-carbon-black rounded-2xl p-6 shadow-brutal flex flex-col gap-4 text-carbon-black">
                    <div className="flex justify-between items-end border-b border-black/10 pb-4">
                      ...
                      <div className="bg-carbon-black text-white w-14 h-14 rounded-full flex items-center justify-center font-bold text-2xl border-2 border-red-500 shadow-brutal-sm">
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.98 }}
                      className="bg-lime-pulse hover:bg-[#97d82f] w-full py-3 border border-carbon-black rounded-xl font-bold text-carbon-black mt-2 transition-all duration-200 shadow-brutal flex items-center justify-center gap-2"
                    >
        ...
        {/* SMART MAP SECTION */}
        <section id="smart-map" className="bg-sky-wash py-16 scroll-mt-24 border-t border-carbon-black/5">
          <div className="max-w-7xl mx-auto px-6">
            <div className="flex flex-col lg:flex-row gap-12 items-center">
              
              {/* Left Column: Interactive Map Mockup */}
              <div className="w-full lg:w-1/2">
                <div className="bg-white border border-carbon-black rounded-2xl p-4 h-[400px] relative overflow-hidden shadow-brutal-dark text-carbon-black">
                  ...
                  <motion.div initial={{ scale: 0 }} whileInView={{ scale: 1 }} className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center z-20">
                    ...
                    <div className="w-4 h-4 bg-blue-600 border border-carbon-black rounded-full z-10 border-white border-[2px] shadow-sm"></div>
                    <div className="mt-2 bg-white border border-carbon-black px-2.5 py-0.5 rounded-full text-[10px] font-bold shadow-brutal-sm whitespace-nowrap">You are here</div>
                  </motion.div>
                  ...
                  <motion.div initial={{ y: -20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.3 }} className="absolute top-1/4 left-1/4 flex flex-col items-center z-10">
                    ...
                    <div className="bg-white border border-carbon-black px-2 py-0.5 flex flex-col items-center rounded-lg text-[10px] font-bold shadow-brutal-sm mt-1">
                      <span>City ER</span>
                  ...
                  <motion.div initial={{ y: -20, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} transition={{ delay: 0.5 }} className="absolute bottom-1/3 right-1/4 flex flex-col items-center z-10">
                    <motion.div animate={{ y: [0, -3, 0] }} transition={{ duration: 2.4, repeat: Infinity, delay: 0.5 }}>
                      <MapPin className="w-6 h-6 fill-green-400 text-carbon-black stroke-[1.5]" />
                    </motion.div>
                    <div className="bg-white border border-carbon-black px-2 py-0.5 flex flex-col items-center rounded-lg text-[10px] font-bold shadow-brutal-sm mt-1">
                  ...
                  <div className="absolute top-4 left-4 right-4 bg-white border border-carbon-black p-3 rounded-xl flex items-center justify-between z-20 shadow-brutal">
                    ...
                    <div className="bg-red-500 text-carbon-black px-3 py-1 rounded-full border border-carbon-black text-xs font-bold shadow-brutal-sm">
                      ER Mode
                    </div>
                  </div>
                </div>
              ...
              <div className="w-full lg:w-1/2 space-y-6 text-carbon-black">
                ...
                <ul className="space-y-4 my-6">
                  <li className="flex items-center gap-3">
                    <div className="bg-white p-2 rounded-full border border-carbon-black flex items-center justify-center w-9 h-9 shadow-none">
                ...
                <div className="flex flex-wrap gap-4 pt-2">
                  <motion.button
                    whileHover={{ scale: 1.03, y: -1, boxShadow: "4px 4px 0px 0px #0a0a0d" }}
                    whileTap={{ scale: 0.97 }}
                    className="bg-carbon-black hover:bg-carbon-black/95 text-white px-8 py-3.5 rounded-full font-bold text-lg border border-carbon-black shadow-brutal transition-all duration-200"
                  >
                    View Hospitals
                  </motion.button>
                  <motion.button
                    whileHover={{ scale: 1.03, y: -1, boxShadow: "4px 4px 0px 0px #0a0a0d" }}
                    whileTap={{ scale: 0.97 }}
                    className="bg-white hover:bg-white text-carbon-black px-8 py-3.5 rounded-full font-bold text-lg border border-carbon-black shadow-brutal transition-all duration-200 flex items-center gap-2"
                  >
        ...
        {/* WAVE MAP -> COMPANY */}
        <WaveDivider fill="#b7eaf6" bg="#b9f0c0" />

        {/* COMPANY SECTION ( Meadow Green Background ) */}
        <section id="company" className="bg-meadow py-20 text-center relative overflow-hidden border-t border-b border-carbon-black/5 text-carbon-black scroll-mt-24">
          <div className="relative z-10 flex flex-col items-center max-w-7xl mx-auto px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto justify-center">
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                onClick={() => navigate('/signup')}
                className="bg-lime-pulse hover:bg-[#97d82f] text-carbon-black px-10 py-5 rounded-full font-bold text-xl border border-carbon-black shadow-brutal transition-all duration-200"
              >
                Try ArogyaAI Now
              </motion.button>
              <motion.button
                ...
                whileTap={{ scale: 0.97 }}
                onClick={() => navigate('/login')}
                className="bg-white hover:bg-white text-carbon-black px-10 py-5 rounded-full font-bold text-xl border border-carbon-black shadow-brutal transition-all duration-200 flex items-center justify-center gap-2"
              >
        ...
        {/* WAVE COMPANY -> FOOTER */}
        <WaveDivider fill="#b9f0c0" bg="#f5f5f5" />

      </main>

      {/* FOOTER */}
      <footer className="bg-fog border-t border-carbon-black/10 py-16 text-carbon-black relative">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            
            <div className="flex flex-col gap-4 col-span-1">
              <div className="flex items-center gap-3">
                <div className="bg-lime-pulse p-1.5 rounded-full border border-carbon-black">
                  <Stethoscope className="w-5 h-5 text-carbon-black stroke-[2.5]" />
                </div>
                <span className="text-2xl font-bold tracking-tight">Arogya<span className="text-lime-pulse">AI</span></span>
              </div>
            ...
            <div className="flex flex-col gap-4">
              ...
              <a href="#" className="text-slate hover:text-lime-pulse font-medium text-sm transition-colors">Voice Assistant</a>
              <a href="#" className="text-slate hover:text-lime-pulse font-medium text-sm transition-colors">AI Triage</a>
              <a href="#" className="text-slate hover:text-lime-pulse font-medium text-sm transition-colors">Emergency System</a>
              <a href="#" className="text-slate hover:text-lime-pulse font-medium text-sm transition-colors">Smart Map</a>
            </div>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between pt-8 border-t border-carbon-black/10 text-slate font-medium text-sm gap-4 text-center md:text-left">
